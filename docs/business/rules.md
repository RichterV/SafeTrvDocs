...
- **Sugerir automaticamente uma rota alternativa** quando o risco é Alto ou Crítico — hoje o sistema avisa que o risco é alto, mas não recalcula sozinho um caminho diferente. Esse é o próximo item do roadmap.
